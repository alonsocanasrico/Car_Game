...
public void setup()
{
  ...
  velocidadA = 18.5f; //velocidad de los adornos
...
{ 
  ...
  if(finaladorno1)
  {
   switch(PApplet.parseInt(random(1,5))){
      case 1:
  ...
  if(finalcoche2)
  {
    ...
    switch(PApplet.parseInt(random(1,5))) // su imagen cambia aleatoriamente a la imagen de otro coche de otro color, o a la de una moto (el procedimiento es el mismo que el que se usó para las imágenes de los adornos
    {
      case 1:
  ...
  if((mouseY < (height-57.5f)) & (mouseY > 57.5f))
  {
    cocheY = mouseY - 57.5f;
  }
  if(mouseY > (height-57.5f)) //si el ratón se pone en el borde superior de la pantalla, el coche se quderá dentro de esta, y no se saldrá la mitad de la imagen por fuera
  {
    cocheY = height - 115;
  }
  if(mouseY < 57.5f)  //si el ratón se pone en el borde inferior de la pantalla, el coche se quderá dentro de esta, y no se saldrá la mitad de la imagen por fuera
  {
    cocheY = 0;
  }
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Car_Game" };
    if (passedArgs != null) {
